=== User List ===
Contributors: ivan82, jonkemp
Tags: user, members, users, directory, profiles, profile, file, files, image, photo, avatar, gravatar
Requires at least: 2.5.1
Tested up to: 3.5.2
Stable tag: 1.5.1

Display your WordPress users and their profiles in an index on your site.
Extrenal plugin support: User Photo, User Files
...
* Supports the "[User Photo](http://wordpress.org/plugins/user-photo/ "User Photo")" plugin for profile images. 
* Supports the "[User Files](http://wordpress.org/plugins/user-files/ "User Files")" plugin for user files.
